...
public class MainRegister {
    public static void main(String[] args) throws FileNotFoundException {
        ...
        try (ObjectOutputStream oos = new ObjectOutputStream(new FileOutputStream("person.csv"))) {
            Student student = new Student("Петренко", "Михаил", "Петрович", "Экономический", 2025);
